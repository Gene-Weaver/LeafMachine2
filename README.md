# LeafMachine2
Updated version of LeafMachine that includes ruler detection and conversion, new segmentation algorithm, new leaf ID tool, neo4j database support.

Work in progress, not stable at this time. Oh yeah, and it's in python this time.
