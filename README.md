...
2. Upgrade numpy and scikit-learn
    ...
    <pre><code class="language-python">pip install -U scikit-image</code></pre>
    <button class="btn" data-clipboard-target="#code-snippet"></button>
...
- If the package installation instructions above fail, try installing only the package that caused the error. For example:
    <pre><code class="language-python">pip install pyyaml</code></pre>
    <button class="btn" data-clipboard-target="#code-snippet"></button>
