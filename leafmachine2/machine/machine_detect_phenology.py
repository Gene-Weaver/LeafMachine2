...
from leafmachine2.machine.directory_structure_P import Dir_Structure
...
def machine(cfg_file_path, dir_home, cfg_test):
    ...
    # Load config file
    report_config(dir_home, cfg_file_path, system='DetectPhenology')

    if cfg_test is None:
        cfg = load_config_file(dir_home, cfg_file_path, system='DetectPhenology')
    else:
        cfg = cfg_test 
