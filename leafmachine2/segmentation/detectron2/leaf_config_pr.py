...
def leaf_config_pr(ZOO_OPT,OUTPUT_DIR,DO_VAL,TRAIN_OR_DETECT,BATCH_SIZE,ITER,ITER_CK,ITER_WARM,N_WORKERS):
    cfg = get_cfg()
    ...
    cfg.merge_from_file(os.path.join('detectron2','projects','PointRend','configs','InstanceSegmentation','pointrend_rcnn_R_50_FPN_3x_coco.yaml'))
    cfg.MODEL.WEIGHTS = os.path.join('detectron2',os.path.dirname(OUTPUT_DIR),'PointRend','point_rend_baseline.pkl')
    ...
    cfg.MODEL.POINT_HEAD.TRAIN_NUM_POINTS = 784 # 392 # default = 196 = 14*14
