...
'''
YOLO has a circular import. Only uncomment for dev
'''
...
if __name__ == "__main__":
    ...
    print(os.getcwd())
    cfg = os.path.join(os.getcwd(),'leafmachine2','keypoint_detector','ultralytics','models','yolo','pose', 'leaf_skeleton_WK_uniform_oriented_traces_mid15_pet5.yaml')
    print(cfg)
    # Train the model
    # https://docs.ultralytics.com/usage/cfg/#modes
    results = model.train(data=cfg, epochs=50, imgsz=640,
                        device=[0, 1],
                        batch=64, #32
                        cache=True,
                        workers=32,
                        project = 'KP_2024',
                        name = 'uniform_spaced_oriented_traces_mid15_pet5_clean_640_flipidx_pt2_kobj40_r',
                        pretrained=True,
                        resume=False,
                        close_mosaic=50,
                        pose=20.0, # best = 20.0
    ...
    # results = model.train(data=cfg, epochs=300, imgsz=640,
    #                     device=[0, 1],
    #                     batch=48,
    #                     cache=True,
    #                     workers=8,
    #                     project = 'KP_Test',
    #                     name = 'uniform_spaced_oriented_traces_clean_640',
    #                     pretrained=False,
    #                     resume=True,
    #                     close_mosaic=0,
    #                     pose=15.0,
