...
if __name__ == "__main__":
    ...
    # model = YOLO(os.path.join(os.getcwd(),'KP_Test','uniform_spaced_oriented_traces_clean_1280','weights','last.pt'))  # load a pretrained model (recommended for training)
    print(os.getcwd())
    ...
    results = model.train(data=cfg, epochs=100, imgsz=1280,
                        ...
                        cache=True,
                        workers=32,
                        project = 'KP_Test_DELETE',
                        name = 'uniform_spaced_oriented_traces_mid15_pet5_clean_1280_2024',
                        pretrained=True,
                        resume=False,
                        close_mosaic=25,
                        pose=20.0,
