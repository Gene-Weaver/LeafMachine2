...
if __name__ == "__main__":
    ...
    print(os.getcwd())
    cfg = os.path.join(os.getcwd(),'leafmachine2','keypoint_detector','ultralytics','models','yolo','pose', 'leaf_skeleton_WK_uniform_oriented.yaml')
    print(cfg)
    # Train the model
    # https://docs.ultralytics.com/usage/cfg/#modes
    results = model.train(data=cfg, epochs=300, imgsz=1280,
                        device=[0, 1],
                        batch=32,
                        cache=True,
                        workers=32,
                        project = 'KP_Test',
                        name = 'uniform_spaced_oriented_traces_clean_1280',
                        close_mosaic=0,
                        pretrained=False,
                        resume=False,
                        pose=15.0,
    ...
    #                     workers=8,
    #                     project = 'KP_Test',
    #                     name = 'uniform_spaced_oriented_traces_640_ptFrom__best_640_uniform_spaced_e150',
    #                     pretrained=True,
    #                     resume=False,
    #                     close_mosaic=0,
    #                     )#, device=[0, 1])
